        ...
        <div className="row mt-3">
          <div className="col-md-12">
            <ResourceTable
              ...
              actions={['add', 'edit', 'delete', 'discount']}
              modalStructure={
                <form ref={this.productForm} onSubmit={this.submitHandler} className="float-left">
                  ...
                  <div className="modal-body">
                    ...
                    <div className="form-group">
                      ...
                      <CustomSelect sourceURL="/api/categories" isMulti={true} innerRef={this.CustomSelectRef} changeHandler={this.optionChangeHandler} value={this.state.selectedCategories} required />
                    </div>
                  </div>
                  <div className="modal-footer">
                    <button ref={this.closeButton} type="button" className="btn btn-secondary" data-dismiss="modal">
                      Cerrar
                    </button>
