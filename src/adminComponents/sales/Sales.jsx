...
import SaleDetails from "../debts/components/DebtDetailsModal";
import { calculateDebtTotal } from "../../helpers";
...
class Sales extends Component {
    constructor() {
        ...
        this.openSaleDetails = this.openSaleDetails.bind(this);
    }
        ...
        d.saleProducts.forEach(saleProduct => {
            ...
            <div class='form-row align-items-center'>
                    ...
                    <div class="col-4">
                        ...
                        <input class="form-control" id="productName" value="${saleProduct.product.name}" disabled/>
                    </div>
                    <div class="col-1">
    ...
    openSaleDetails(saleDetails) {
        this.setState({ saleDetails, showSaleDetails: true }, () => {
        ...
        return (
            <div className="">
                ...
                <div className="row mt-3">
                    <div className="col-md-12">
                        <ResourceTable openSaleDetails={this.openSaleDetails} asyncTable={true} childFormat={this.childFormat} sourceURL={"/api/sales"} columns={[
                            { title: "ID Venta", data: "id" },
                            /*
                            {
                                "title": "Productos",
