            ...
            <div className="">
                ...
                <div className="row mt-3 justify-content-center">
                    {this.state.paymentInfo && this.state.paymentInfo.map(paymentType => {
                        return (
                            <div key={paymentType.id} className="col-md-3">
                                <div className="card" >
                                    ...
                                    <div className="card-body">
                                        {paymentType.currency == "Bs" ? <p className="card-text h4">{Intl.NumberFormat("es-VE", { currency: "VES" }).format(paymentType.amountTotal) + " " + paymentType.currency}</p>
                                            : <p className="card-text h4">{Intl.NumberFormat("en-US", { style: "currency", currency: "USD" }).format(paymentType.amountTotal)}</p>}
