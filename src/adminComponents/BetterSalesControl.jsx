                    ...
                    <div className="col-12">
                        <form onSubmit={this.addProductToTableHandler}>
                            <div className="row">
                                ...
                                <div className="col-12 col-lg-3 mt-2">
                                    <input onFocus={this.onFocusHandler} ref={this.quantityInput} onChange={this.onInputChangeHandler} step="0.01" type="number" className="form-control" placeholder="Cantidad" id="quantity" name="quantity" defaultValue="1" />
                                </div>
